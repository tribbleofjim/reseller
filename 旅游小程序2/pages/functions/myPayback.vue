...
<template>
	<view class="qiun-columns">
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">分销商</view>
		</view>
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">我的回馈</view>
		</view>
		<!--#endif-->
...
<script>
	import uCharts from '@/components/chart/u-charts.js';
	import  { isJSON } from '@/components/chart/checker.js';
	var _self;
	var canvaLineA=null;
